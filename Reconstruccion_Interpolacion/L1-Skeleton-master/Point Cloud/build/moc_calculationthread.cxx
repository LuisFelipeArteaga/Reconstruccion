...
static const char qt_meta_stringdata_CalculationThread[] = {
    "CalculationThread\0\0update()\0"
};
...
const QMetaObjectExtraData CalculationThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CalculationThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CalculationThread,
      qt_meta_data_CalculationThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CalculationThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CalculationThread))
