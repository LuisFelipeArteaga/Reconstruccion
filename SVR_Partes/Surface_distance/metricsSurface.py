...
import Surface_distance.lookup_tables as lookup_tables1 # pylint: disable=relative-beyond-top-level
import numpy as np
...
def compute_surface_distances(mask_gt, mask_pred, spacing_mm):
  ...
  for code in range(256):
    normals = np.array(lookup_tables1.neighbour_code_to_normals[code])
    sum_area = 0
